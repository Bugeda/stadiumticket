...
public class EventDAOTest{
    ...
    public void entityListTest() throws ParseException{
    	 ...
    	 * 
	 	Event ev1=new Event(1, "���������� - �������", new Timestamp(sdf.parse("2014-05-18 15:00:00").getTime()), 30);
    	Event ev2=new Event(2, "������� - ����������", new Timestamp(sdf.parse("2014-05-20 16:00:00").getTime()), 30);
    	Event ev3=new Event(3, "���������� - �������", new Timestamp(sdf.parse("2014-05-23 11:00:00").getTime()), 30);
    	Event ev4=new Event(4, "������� - ����������", new Timestamp(sdf.parse("2014-05-23 19:00:00").getTime()), 30);
    	Event ev5=new Event(5, "���������� - �������", new Timestamp(sdf.parse("2014-05-16 17:00:00").getTime()), 30);
    	Event ev6=new Event(6, "������ - ������", new Timestamp(sdf.parse("2014-05-18 14:00:00").getTime()), 30);
    	Event ev7=new Event(7, "��������� - �������", new Timestamp(sdf.parse("2014-05-18 12:00:00").getTime()), 30);    
    	Event ev8=new Event(8, "������� - ����������", new Timestamp(sdf.parse("2014-05-20 14:00:00").getTime()), 30);
