...
public class EventDAOTest{
	...
	Event ev1=new Event(1, "���������� - �������", new Timestamp(sdf.parse("2014-05-18 15:00:00").getTime()), 30, new ArrayList<SectorPrice>());
    	...
    	Event ev5=new Event(5, "���������� - �������", new Timestamp(sdf.parse("2014-05-16 17:00:00").getTime()), 30, new ArrayList<SectorPrice>());
    	Event ev6=new Event(6, "������ - ������", new Timestamp(sdf.parse("2014-05-18 14:00:00").getTime()), 30, new ArrayList<SectorPrice>());
    	Event ev7=new Event(7, "��������� - �������", new Timestamp(sdf.parse("2014-05-18 12:00:00").getTime()), 30, new ArrayList<SectorPrice>());
    	Event ev8=new Event(8, "������� - ����������", new Timestamp(sdf.parse("2014-05-20 14:00:00").getTime()), 30, new ArrayList<SectorPrice>());
