	...
	<div class="col-md-5">
	 	<form:form class="form-horizontal"  action="${pageContext.request.contextPath}/new_event" method="post" modelAttribute="newEvent">
            ...
            <div class="form-group">
              ...
              <input class="form-control"  name="eventDate"  id="start" value="${formattedDate}" placeholder="${msg}" title="${msg}"  maxlength="0"/>
            ...
            <div class="form-group">
              ...
              <form:input class="form-control" type="text" path="bookingCancelTime" id="booking_time" value="30" placeholder="${msg}" title="${msg}" maxlength="3"/>
