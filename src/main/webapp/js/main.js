$(document).ready(function () {
	...
	$('#ticket_list').append("<tr class=\"ticket\"><td class=\"ticket_number\"></td>"+"<td>"
				 ...
				 + "<td><input name=\"${booking.ticket[].seat.sector.id}\" type=\"hidden\" value="+sector+">"
				 + "<input name=\"${booking.ticket[].seat.rowNumber}\" type=\"hidden\" value="+row+">"
				 + "<input name=\"${booking.ticket[].seat.seatNumber}\" type=\"hidden\" value="+seat+"></td></tr>" );
